...
namespace Console
{
        ...
        public Doctor(string inputPass)
        {
            ...
            switch (a)
            {
                ...
                case '3':
                    ...
                    System.Console.WriteLine("=====================");
                    Disease akram = new Cancer("Akram", new Stage_1());
                    Disease ali = new Cancer("Ali", new Stage_2());
                    akram.info();
                    ali.info();

                    Disease saad = new Pneumonia("Saad", new Stage_2());
                    saad.info();

                    Disease khalid = new Infection("Khalid", new Stage_1());
                    khalid.info();
                    break;
    ...
    public class Login
    {
        string docUsername = "doc";
        string docPass = "doc123";
        string patUsername = "pat";
        string patPass = "pat123";
        string inputUser;
        string inputPass;
